...
def generate_analysis_report(
    ...
    sections.append("## 2. Adjudicator Verdict Distribution\n")
    ...
    # === 3. Adjudicator Reasoning ===
    sections.append("## 3. Adjudication Details\n")
    ...
    # === 4. Agent Performance ===
    sections.append("## 4. Agent Performance Summary\n")
    ...
    if mode == "bloodsport":
        bs_agents = [(n, s) for n, s in sorted_agents if s.get('bloodsport_exchanges', 0) > 0]
        if bs_agents:
    ...
    # === 5. Belief Evolution ===
    sections.append("## 5. Belief Evolution Summary\n")
    for agent in agents:
    ...
    if convergence_history:
        sections.append("## 6. Convergence Trajectory\n")
